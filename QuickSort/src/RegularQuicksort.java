...
public class RegularQuicksort {
    ...
    public static int[] quickSort(int[] toBeSorted) {
        RegularQuicksort.quickSortHelp(toBeSorted, 0, toBeSorted.length);
        return toBeSorted;
    }
    ...
    public static void quickSortHelp(int[] toBeSorted, int start, int length) {
        if (length <= 1) {
            ...
            int pivotIndex = start + RegularQuicksort.rng.nextInt(length);
            ...
            RegularQuicksort.quickSortHelp(toBeSorted, start, leftCount);
            System.out.println("right");
            RegularQuicksort.quickSortHelp(toBeSorted, start + leftCount + 1, rightCount);
        }
    }
    ...
    public static void main(String[] args) {
        ...
        System.out.println(Arrays.toString(RegularQuicksort.quickSort(toBeSorted)));
