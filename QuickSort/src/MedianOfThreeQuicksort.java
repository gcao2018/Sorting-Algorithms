...
public class MedianOfThreeQuicksort {
    ...
    public static int[] quickSort(int[] toBeSorted) {
        MedianOfThreeQuicksort.quickSortHelp(toBeSorted, 0, toBeSorted.length);
        return toBeSorted;
    }
    ...
    public static void quickSortHelp(int[] toBeSorted, int start, int length) {
        if (length <= 1) {
            ...
            int pivotIndex = MedianOfThreeQuicksort.medianOfThree(start, start + length / 2, length);
            ...
            MedianOfThreeQuicksort.quickSortHelp(toBeSorted, start, leftCount);
            System.out.println("right");
            MedianOfThreeQuicksort.quickSortHelp(toBeSorted, start + leftCount + 1, rightCount);
        }
    }
    ...
    public static int medianOfThree(int int1, int int2, int int3) {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(Arrays.toString(MedianOfThreeQuicksort.quickSort(toBeSorted)));
        ...
        //System.out.println(medianOfThree(0, 1, 2));
    }
}